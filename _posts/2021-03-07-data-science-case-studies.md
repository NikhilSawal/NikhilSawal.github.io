...
{% include conversion_over_time.png %}
...
{% include first_inter_length_dist.png %}

{% include count_interaction_dist.png %}
...
{% include contact_channel_aban_conv_rate.png %}
...
{% include time_spent_contact_me.png %}  
